...
No board mutation commands are currently available.
...
The current native-startup blocker and resume procedure are recorded in
[live acceptance](live-acceptance.md). Do not mistake the staged probe files
